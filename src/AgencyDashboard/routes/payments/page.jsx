...
import { Search, MoreHorizontal, Edit, Check, X, ChevronDown, RefreshCw, Eye } from "lucide-react";
...
const PaymentManagementPage = () => {
  ...
  const fetchPayments = async () => {
    try {
      ...
      console.log('✅ Agency payments loaded successfully:', paymentsData.length, 'payments');
    } catch (err) {
  ...
  const {
    ...
    resetPagination
  } = usePagination(filteredPayments, 5); // Reduced to 5 for testing
  ...
  console.log('🔍 Pagination Values:', {
    ...
    totalPages,
    totalItems,
    currentPaymentsLength: currentPayments.length
  });
